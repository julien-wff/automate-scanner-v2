module.exports.flows = `
    ...
    (
        ...
        \`base64-data\`    longtext CHARACTER SET utf8 COLLATE utf8_general_ci     NOT NULL,
        PRIMARY KEY (\`id\`)
    ) ENGINE = InnoDB
...
module.exports.reviews = `
    ...
    (
        ...
        \`comment\`  mediumtext CHARACTER SET utf8 COLLATE utf8_general_ci NULL     DEFAULT NULL,
        \`created\`  datetime                                              NOT NULL DEFAULT CURRENT_TIMESTAMP,
